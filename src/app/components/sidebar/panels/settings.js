...
import { colorPresets } from "@/app/config/EditorConfig";
...
function SettingsPanel() {
  ...
  const { canvas, markAsModified } = useTshirtStore();
  ...
  return (
    <div className="p-4 space-y-6">
      <div className="flex items-center space-x-2 mb-4">
        ...
        <h3 className="text-lg font-semibold whitespace-nowrap">Choose Background Color</h3>
      </div>
